...
//   );
//   t.true(
//     t.context.log.calledWith('Added labels %O to issue #%d', ['released on @next', 'released from master'], 1)
//   );
//   t.true(github.isDone());
// });
...
// test('Skip commention on issues/PR if "successComment" is "false"', async () => {
//   const owner = 'test_user';
//   const repo = 'test_repo';
//   const env = { GITHUB_TOKEN: 'github_token' };
//   const failTitle = 'The automated release is failing 🚨';
...
// test('Skip closing issues if "failComment" is "false"', async () => {
//   const owner = 'test_user';
//   const repo = 'test_repo';
//   const env = { GITHUB_TOKEN: 'github_token' };
...
// test('Skip closing issues if "failTitle" is "false"', async () => {
//   const owner = 'test_user';
//   const repo = 'test_repo';
//   const env = { GITHUB_TOKEN: 'github_token' };
